...
import com.opengl.bigjelly.android_opengl_example.lesson3.Cube;
 ...
 * @since 2019/03/08
 */
public class Lesson4Render implements GLSurfaceView.Renderer {
    private Context context;

    Cube cube;

    public Lesson4Render(Context context) {
